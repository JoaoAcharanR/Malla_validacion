...
data_errorpro   <- data_errorpro %>% add_column(ERRORPRO_1  = data_enut %>% transmute(errorpro = xor(f11_1_1 == 1, !is.na(f12_1_1))))
data_ERRORPRO_1 <- data_errorpro %>% filter(ERRORPRO_1 == TRUE)
...
data_errorpro   <- data_errorpro %>% add_column(ERRORPRO_2  = data_enut %>% transmute(errorpro = xor(f11_1_1 == 2, is.na(f12_1_1))))
data_ERRORPRO_2 <- data_errorpro %>% filter(ERRORPRO_2 == TRUE)
...
data_errorpro   <- data_errorpro %>% add_column(ERRORPRO_3  = data_enut %>% transmute(errorpro = xor(f11_1_1 == 1, !is.na(f13_1_1))))
data_ERRORPRO_3 <- data_errorpro %>% filter(ERRORPRO_3 == TRUE)
...
data_errorpro   <- data_errorpro %>% add_column(ERRORPRO_4  = data_enut %>% transmute(errorpro = xor(f11_1_1 == 2, is.na(f13_1_1))))
data_ERRORPRO_4 <- data_errorpro %>% filter(ERRORPRO_4 == TRUE)
...
data_errorcon   <- data_errorcon %>% add_column(ERRORCON_1 = data_enut %>% transmute(errorcon = xor(c14_1_1 <= 21, d12_1_1 == 14 | d12_1_1 == 15)))
